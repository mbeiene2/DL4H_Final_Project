...
# Michael Beiene
# DL4H UIUC
# Level 2 Labels model for GRU(X) - GRU(Z) and tfidf(d)-atomic
# May 2022
# Version 1.0
...
ICD9_CODE_SECOND_LEVEL = ['001-009', '010-018', '020-027', '030-041', '042-042', '045-049', '050-059', '060-066',
                          ...
                          '239-239', '240-246', '249-259', '260-269', '270-279', '280-285', '286-287', '288-289', '290-294', '295-299',
                          '300-316', '317-319', '320-326', '330-337', '338-338', '340-349',
                          ...
                          '700-709', '710-719', '720-724', '725-729', '730-739', '740-742', '743-744', '745-747', '748-748', '749-751',
                          '752-752', '753-753', '754-756', '757-757', '758-758', '759-759', '760-763', '764-779', '780-789',
...
# ### Convert labels to Level-2 labels

# In[21]:


train_labels = [replace_with_grandparent_codes(x, ICD9_CODE_SECOND_LEVEL) for x in labels_final]
...
y_true, y_pred = evaluate_results(inputs=X_test,
                                  ...
                                  target_codes=ICD9_CODE_SECOND_LEVEL,
...
labels_b = [replace_with_grandparent_codes(x, ICD9_CODE_SECOND_LEVEL, add_start_end=False) for x in labels_final_b]
...
label_vectors, label_codes = vectorize_icd_labels(labels=labels_b,
                                                  code_list=ICD9_CODE_SECOND_LEVEL,
